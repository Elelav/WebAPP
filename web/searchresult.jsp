                            ...
                            <%
                                ...
                                switch (tableName) {
                                    ...
                                    case ("COMPANIES"):
                                       ...
                                       <div class="editSubmit"><a href="itemedit.jsp?id=<%out.println(dbi[i].getItemValues()[0]);%>&tableName=<%out.println(tableName);%>"><input type='submit' value='Редактировать'></a></div>
                                       <%                                                                
                                    }break;
                                    case ("DEVELOPERS"):
                                    %><h1>Search results for <%out.print(inputData);%>:</h1><%
